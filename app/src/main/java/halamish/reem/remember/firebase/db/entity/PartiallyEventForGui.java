...
//
//    public PartiallyEventForGui() {
//        this("2017/08/21",
//                "10:00",
//                "",
//                "",
//                LocalRam.getManager().getUsername(),
//                EventNotificationPolicy.DONT_NOTIFY.toString(),
//                FirebaseDbManager.getManager().getNewEventId(),
//                false,
//                true);
//    }
//
...
//    }
//
////    public PartiallyEventForGui(String date, String time, String title, String body, String creator, String policy, boolean isPublic) {
////        this(date, time, title, body, creator, policy, FirebaseDbManager.getManager().getNewEventId(),isPublic, true);
////    }
//
//    public Date asDate() {
//        try {
